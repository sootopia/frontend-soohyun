          ...
          <div className="flex flex-col max-w-7xl mx-auto border-t border-gray-200">
            {EXPERIENCES.map((item, index) => (
              <Reveal key={item.company} delay={index * 0.08}>
                <article className="flex flex-col lg:flex-row py-5 md:py-6 border-b border-gray-200 items-stretch lg:items-start">
                  ...
                  <div className="flex-1 mt-6 md:mt-8 lg:mt-0 lg:ml-auto lg:pl-25">
                    <ul className="text-[15px] md:text-base leading-relaxed text-gray-600 break-keep">
